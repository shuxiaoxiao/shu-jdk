 ...
 * 实际项目使用用org.springframework.beans.BeanUtils
 * @author shu
 */
@Deprecated
public class ReflectionUtil {
	 ...
	 *            要提取的属性名.
	 */
	// public static List fetchElementPropertyToList(final Collection
	 ...
	 *            分隔符.
	 */
	// public static String fetchElementPropertyToString(final Collection
